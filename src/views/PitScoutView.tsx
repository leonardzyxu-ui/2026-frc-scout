  ...
  const cards = [
    {
      ...
      detail: `${form.expectedAutoBalls || 0} auto / ${form.expectedTeleopBalls || 0} teleop becomes the early PPA prior.`
    },
    {
      label: 'Floor Watch',
  ...
  return (
    <section className="admin-g2 border border-emerald-400/25 bg-emerald-500/10 p-5">
      ...
      <div className="mt-2 text-xs font-semibold leading-relaxed text-emerald-50/70">
        This is not final PPA. It is the human prior Admin V4 uses before enough match rows exist, and it tells match scouts what to prove or disprove.
      </div>
    </section>
  );
}
