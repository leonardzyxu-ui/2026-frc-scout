...
const AdminMainframeV2View = lazy(() => import('./views/AdminMainframeV2View'));
        ...
        <div className="mx-auto flex min-w-0 max-w-7xl flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
          <div className="min-w-0">
            ...
            <div className="mt-1 flex flex-wrap items-center gap-2">
              <h1 className="min-w-0 text-xl font-black tracking-tight text-white md:text-2xl">Evidence To PPA To Strategy</h1>
              {isLocalMode && (
      ...
      <ScoutProvider>
        <Router>
          <Routes>
            ...
            <Route path="/adminv4" element={<AdminGuard><Suspense fallback={<RouteLoading label="Loading Admin V4..." />}><AdminMainframeV2View /></Suspense></AdminGuard>} />
