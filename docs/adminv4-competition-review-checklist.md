...
- Use the Live Pick Call Sheet first; it should show the primary choice, backup choice, swing choice, blocker choice, why-now reason, and status controls after every live status change.
